    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button_Save).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                data.putExtra("user_question",((EditText) findViewById(R.id.answer_Add)).getText().toString() ); // puts one string into the Intent, with the key as 'string1'
                data.putExtra("user_answer", ((EditText) findViewById(R.id.question_Add)).getText().toString()); // puts another string into the Intent, with the key as 'string2
